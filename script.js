/* ============================================================
   ...
   Navbar, countdown, scroll reveal, marquee
   ============================================================ */
...
(function heroParallax() {
  ...
  document.addEventListener('mousemove', e => {
    ...
    requestAnimationFrame(() => {
      ...
      // Move the pseudo glow via a custom property
      hero.style.setProperty('--mx', `${50 + cx * 8}%`);
      hero.style.setProperty('--my', `${-20 + cy * 8}%`);
      ticking = false;
    });
  }, { passive: true });
})();

// ─── Marquee: inject duplicated items for seamless loop ──────────
...
(function statsCountUp() {
  // No numeric count-up needed here — values are categorical / mixed
  // But we add a stagger reveal via the data-reveal system above
})();
